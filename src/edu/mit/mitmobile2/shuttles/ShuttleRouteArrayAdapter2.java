...
public class ShuttleRouteArrayAdapter2 implements ListAdapter {
...
//	private static final int DIRECTION_HEADER_VIEW_TYPE = 0;
	...
	public ShuttleRouteArrayAdapter2(Context context, SectionListItemView itemBuilder) {
	...
	public ShuttleRouteArrayAdapter2(Context context, SectionListHeaderView headerBuilder, SectionListItemView itemBuilder) {
		mTitles = new ArrayList<String>();
		mItemLists = new ArrayList<List<?>>();
		mContext = context;
		mItemBuilder = itemBuilder;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (viewType == STOP_HEADER_VIEW_TYPE) {

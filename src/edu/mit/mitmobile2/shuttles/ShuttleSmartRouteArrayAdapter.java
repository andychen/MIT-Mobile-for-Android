...
//	private static final int DIRECTION_HEADER_VIEW_TYPE = 0;
	...
	public ShuttleSmartRouteArrayAdapter(Context context, SectionListItemView itemBuilder) {
	...
	public ShuttleSmartRouteArrayAdapter(Context context, SectionListHeaderView headerBuilder, SectionListItemView itemBuilder) {
		mTitles = new ArrayList<String>();
		mItemLists = new ArrayList<List<?>>();
		mContext = context;
		mItemBuilder = itemBuilder;
